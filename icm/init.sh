...
if [ "${IMAGE_LOCAL}" = "true" ]; then
    # import images
    docker load -i "${BASE_DIR}/images/icm-all.tar"
fi
...
chmod +x  ${BASE_DIR}/volume/icm-proxy/script/docker-entrypoint.sh
chmod 777 ${BASE_DIR}/volume/icm-web/logs
chmod 777 ${BASE_DIR}/volume/icm-web/logs-1
chmod 777 ${BASE_DIR}/volume/icm-web/logs-2
chmod +x  ${BASE_DIR}/volume/icm-web/script/docker-entrypoint.sh
