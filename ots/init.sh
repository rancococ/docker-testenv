...
if [ "${IMAGE_LOCAL}" = "true" ]; then
    # import images
    docker load -i "${BASE_DIR}/images/ots-all.tar"
fi
...
chmod +x  ${BASE_DIR}/volume/ots-proxy/script/docker-entrypoint.sh
chmod 777 ${BASE_DIR}/volume/ots-web/logs
chmod 777 ${BASE_DIR}/volume/ots-web/logs-1
chmod 777 ${BASE_DIR}/volume/ots-web/logs-2
chmod +x  ${BASE_DIR}/volume/ots-web/script/docker-entrypoint.sh
chmod 777 ${BASE_DIR}/volume/ots-service/logs
chmod 777 ${BASE_DIR}/volume/ots-service/logs-1
chmod 777 ${BASE_DIR}/volume/ots-service/logs-2
chmod +x  ${BASE_DIR}/volume/ots-service/script/docker-entrypoint.sh
